    ...
    def parse(self, response):
        try:
            ...
            if match:
                ...
                temp_item['Uses'] = [i['name'] for i in
                                     data['drugPageReducer']['data']['composition']['uses'][0]['values']]
                ...
                if len(data['drugPageReducer']['data']['composition']['introduction']) > 0:
                    temp_item['intro_1'] = data['drugPageReducer']['data']['composition']['introduction'][0][
                        'display_text']
                else:
                ...
                # side_effects
                temp_item['side_effects'] = [i['values'] for i in
                                             data['drugPageReducer']['data']['composition']['side_effects'][0][
                                                 'values']]
